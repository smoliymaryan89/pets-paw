...
const Modal = ({ handleModal }: ModalProps) => {
  ...
  return createPortal(
    ...
    >
      <div className="absolute top-0 right-0 p-[20px] bg-dark-white dark:bg-light-dark h-full w-full lg:w-1/2 lg:rounded-20 lg:top-[30px] lg:right-[30px] lg:h-[calc(100vh-60px)]">
        <Button
          icon="icon-close"
          btnStyles="absolute top-[20px] right-[25px] w-[60px] h-[60px] bg-white dark:bg-grey-0.05 rounded-20 hover:!bg-pink md:right-[30px]"
        ...
        <div className="gallery-modal-scroll w-full h-full md:overflow-auto md:min-h-full">
          <div className="mt-[80px] max-w-[335px] mx-auto md:max-w-full">
            <h1 className="mb-[20px] text-dark dark:text-white text-20 font-medium text-center md:text-36 md:mb-[10px]">
            ...
            <div
              className={clsx(
                "relative cursor-pointer rounded-20 border-[2px] border-dashed px-[20px] py-[10px] flex items-center justify-center h-[168px] mb-[11px] md:w-[640px] md:h-[320px] md:px-[40px] md:py-[20px] md:mb-[20px] md:mx-auto",
                !imageUrl &&
                  'bg-[url("/images/upload-bg.png")] dark:bg-[url("/images/dark-upload.png")] bg-no-repeat bg-center bg-[length:100px] md:bg-[length:200px]',
                uploadImage.isError
                  ? "bg-light-pink border-pink dark:bg-pink-20"
                  : "bg-white border-light-pink dark:border-pink-20 dark:bg-grey-0.05"
              )}
            >
              {imageUrl ? (
                <img
                ...
                <p className="text-20 dark:text-grey leading-normal max-w-[199px] text-center md:max-w-full">
            ...
            {imageName ? (
              <>
                ...
                <Button
                  ...
                  btnStyles={clsx(
                    "w-full bg-pink py-[12px] text-12 gap-[10px] font-medium leading-[1.3] tracking-[2px] text-white md:max-w-[172px] md:mx-auto",
                    !uploadImage.isPending &&
                      "hover:bg-light-pink hover:text-pink"
                  )}
